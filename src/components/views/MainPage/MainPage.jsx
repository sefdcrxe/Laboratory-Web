...
function MainPage() {
  return (
    ...
    <div className="Frame2" style={{width: 1448, height: 794, position: 'relative'}}>
  <div className="Group10" style={{width: 1447, height: 794, left: 0, top: 0, position: 'absolute'}}>
    ...
    <div className="Project" style={{left: 191, top: 197, position: 'absolute', color: '#412C86', fontSize: 24, fontFamily: 'The Jamsil', fontWeight: '400', wordWrap: 'break-word'}}>PROJECT</div>
    <div className="DonggukUniversity" style={{left: 1250, top: 33, position: 'absolute', textAlign: 'right', color: '#777777', fontSize: 20, fontFamily: 'The Jamsil', fontWeight: '400', wordWrap: 'break-word'}}>Dongguk University</div>
    ...
    <div className="Home" style={{left: 63, top: 198, position: 'absolute', color: 'white', fontSize: 24, fontFamily: 'The Jamsil', fontWeight: '400', wordWrap: 'break-word'}}>HOME</div>
  </div>
